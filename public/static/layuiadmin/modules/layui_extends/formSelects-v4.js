...
(function (e, t, n) {
    ...
    var t = "4.0.0.0910", v = "xm-select", m = "xm-select-parent", y = "xm-select-input", g = "xm-select--suffix",
        w = "xm-select-this", x = "xm-select-label", k = "xm-select-search", b = "xm-select-search-type",
        C = "xm-select-show-count", S = "xm-select-create", d = "xm-select-create-long", T = "xm-select-max",
        L = "xm-select-skin", j = "xm-select-direction", A = "xm-select-height", E = "xm-dis-disabled",
        N = "xm-select-dis", p = "xm-select-temp", D = "xm-select-radio", H = "xm-select-linkage", F = "xm-select-dl",
        h = "xm-select-hide", _ = "xm-hide-input", O = "xm-select-sj", e = "xm-icon-close", I = "xm-select-title",
        P = "xm-form-select", f = "xm-form-selected", V = "xm-select-none", U = "xm-select-empty", M = "xm-input",
        W = "xm-dl-input", J = "xm-select-tips", s = "xm-iconfont", B = "XM_PID_VALUE", R = "xm-cz", l = "xm-cz-group",
        n = "请选择", q = {}, z = {on: {}, endOn: {}, filter: {}, maxTips: {}, opened: {}, closed: {}}, X = {
            type: "get",
            header: {},
            first: true,
            data: {},
            ...
            error: null,
            beforeSearch: null,
            response: {statusCode: 0, statusName: "code", msgName: "msg", dataName: "data"},
            tree: {
                nextClick: function e(t, n, i) {
                    i([])
                }, folderChoose: true, lazy: true
            }
        }, i = [{
            icon: "xm-iconfont icon-quanxuan", name: "全选", click: function e(t, n) {
                n.selectAll(t, true, true)
            }
        }, {
            icon: "xm-iconfont icon-qingkong", name: "清空", click: function e(t, n) {
                n.removeAll(t, true, true)
            }
        }, {
            icon: "xm-iconfont icon-fanxuan", name: "反选", click: function e(t, n) {
                n.reverse(t, true, true)
            }
        }, {
            icon: "xm-iconfont icon-pifu", name: "换肤", click: function e(t, n) {
                n.skin(t)
            }
        }], Q = window.$ || window.layui && window.layui.jquery, c = Q(window), Y = {}, a = {}, r = {}, $ = function e(t) {
            var l = this;
            this.config = {
                name: null,
                max: null,
            ...
            Q.extend(this.config, t, {
                ...
                placeholder: t.optionsFirst ? t.optionsFirst : n,
    ...
    o.prototype.appender = function () {
        if (!Array.prototype.map) {
            Array.prototype.map = function (e, t) {
                var n, i, a, r = Object(this), l = r.length >>> 0;
                if (t) {
                    n = t
                }
                i = new Array(l);
    ...
    o.prototype.init = function (e) {
        ...
        Q(e ? e : "select[" + v + "]").each(function (e, t) {
            var n = Q(t), i = n.attr(v), a = n.next(".layui-form-select"), r = n.next("." + m), l = {
                name: i,
                disabled: t.disabled,
                max: n.attr(T) - 0,
                ...
                skin: n.attr(L),
                direction: n.attr(j),
                optionsFirst: n.attr('xm-select-placehoder'),
                height: n.attr(A),
                ...
                return {name: e.innerHTML, value: e.value}
            }), s = new $(l);
            s.values = o;
            if (s.config.init) {
                s.values = s.config.init.map(function (e) {
                    ...
                    return {name: n.find('option[value="' + e + '"]').text(), value: e}
                }).filter(function (e) {
                    return e.name
                });
            ...
            if (s.config.isSearch) {
                Y[i] = Q.extend({}, X, {searchUrl: s.config.searchUrl}, Y[i]);
    ...
    o.prototype.search = function (a, e, t, n) {
        ...
        var s = Y[a] ? Y[a] : X;
        t = s.searchUrl || t;
        var d = q[a], c = d.config.isCreate, f = Q('dl[xid="' + a + '"]').parents("." + P);
        if (t) {
            if (s.searchVal) {
                o = s.searchVal;
                s.searchVal = ""
        ...
        var t = function e() {
            ...
            Q.each(t, function (a, e) {
                Q.each(e, function (e, t) {
                    var n = {pid: a, name: t[s.keyName], value: t[s.keyVal]};
    ...
    o.prototype.create = function (e, t, n) {
        if (t && n) {
            var i = q[e], a = Q('[xid="' + e + '"]'), r = a.find("dd." + J + "." + W), l = null, o = a.find("dd." + p);
            ...
            if (!l) {
                ...
                if (o[0]) {
                    ...
                    r.after(Q(this.createDD(e, {name: n, innerHTML: n, value: s}, p + " " + d)))
                }
            }
        } else {
            Q("[xid=" + e + "] dd." + p).remove()
    ...
    o.prototype.renderBtns = function (e, t, n) {
        ...
        a.push("</div>");
        a.push(this.createQuickBtn({icon: "xm-iconfont icon-caidan", name: ""}));
        return a.join("")
    };
    ...
    o.prototype.one = function (e) {
        ...
        Q(e ? e : document).off("click", "." + I).on("click", "." + I, function (e) {
            var t = Q(e.target), n = t.is(I) ? t : t.parents("." + I), i = n.next(), a = i.attr("xid");
            ...
            if (n.find("." + y + ":not(readonly)")[0]) {
                var r = n.find("." + y), l = {x: e.pageX, y: e.pageY}, o = C.getPosition(n[0]), s = n.width();
                while (l.x > o.x) {
            ...
            if (t.is('i[fsw="' + v + '"]')) {
                var d = C.getItem(a, t), c = i.find("dd[lay-value='" + d.value + "']");
                if (c.hasClass(E)) {
                    return false
                }
        ...
        Q(e ? e : document).off("click", "dl." + F).on("click", "dl." + F, function (e) {
            ...
            if (t.is("." + H) || t.parents("." + H)[0]) {
                ...
                var n = t.parents(".xm-select-linkage-group"), i = t.parents("dl").attr("xid");
                if (!i) {
                    return false
                }
                ...
                if (!a[0] || a.find("li:not(.xm-select-linkage-hide)").length == 0) {
                    var r = [], l = 0, o = !t.hasClass("xm-select-this");
                    if (q[i].config.radio) {
                        t.parents(".xm-select-linkage").find(".xm-select-this").removeClass("xm-select-this")
                    }
                    do {
                        r[l++] = {name: t.find("span").text(), value: t.attr("xm-value")};
    ...
    o.prototype.getItem = function (e, t) {
        if (t instanceof Q) {
            if (t.is('i[fsw="' + v + '"]')) {
                var n = t.parent();
                return G[e][t] || {name: n.find("font").text(), value: n.attr("value")}
            }
            var i = t.attr("lay-value");
            return !G[e][i] ? G[e][i] = {name: t.find("span[name]").attr("name"), value: i} : G[e][i]
        } else if (typeof t == "string" && t.indexOf("/") != -1) {
            return G[e][t] || {name: this.valToName(e, t), value: t}
        }
        return G[e][t]
    };
    ...
    o.prototype.linkageDel = function (e, t) {
        var n = Q('dl[xid="' + e + '"]');
        var i = t.value.split("/");
        var a = void 0, r = void 0, l = i.length - 1;
        do {
            a = i[l];
            r = n.find(".xm-select-linkage-group" + (l + 1) + ' li[xm-value="' + a + '"]');
    ...
    o.prototype.initVal = function (e) {
        ...
        Q.each(t, function (n, e) {
            var t = e.values, i = Q('dl[xid="' + n + '"]').parent(), a = i.find("." + x), r = i.find("dl");
    ...
    o.prototype.handlerLabel = function (e, t, n, i, a) {
        var r = Q('[xid="' + e + '"]').prev().find("." + x), l = t && this.getItem(e, t), o = q[e].values,
            s = q[e].config.on || z.on[e], d = q[e].config.endOn || z.endOn[e];
        if (i) {
            l = i
        }
        var c = q[e];
    ...
    o.prototype.retop = function (e) {
        var t = e.find("dl"), n = e.offset().top + e.outerHeight() + 5 - c.scrollTop(), i = t.outerHeight();
        ...
        if (a) {
            t.css({top: "auto", bottom: o + 3 + "px"})
        } else {
            t.css({top: o + "px", bottom: "auto"})
        }
    };
    o.prototype.changeShow = function (e, t) {
        Q(".layui-form-selected").removeClass("layui-form-selected");
        var n = e.parents("." + P), i = n.hasClass(f), a = n.find("dl").attr("xid");
    ...
    o.prototype.changePlaceHolder = function (e) {
        ...
        if (q[n] && q[n].config.height) {
            ...
            if (a.is(".layui-form-label") && t.parents(".layui-form-pane")[0]) {
                i = i > 36 ? i + 4 : i;
                t.css("height", i + "px");
                a.css({height: i + 2 + "px", lineHeight: i - 18 + "px"})
            }
        }
        var r = t.find("." + g + " input"), l = !e.find("span:last")[0] && !t.find("." + y).val();
        if (l) {
            var o = r.attr("back");
            r.removeAttr("back");
    ...
    o.prototype.removeAll = function (n, i, a) {
        ...
        q[n].values.concat([]).forEach(function (e, t) {
            if (a && l.find('dd[lay-value="' + e.value + '"]').hasClass(E)) {
            } else {
    ...
    o.prototype.onreset = function () {
        Q(document).on("click", "[type=reset]", function (e) {
            Q(e.target).parents("form").find("." + m + " dl[xid]").each(function (e, t) {
                var n = t.getAttribute("xid"), i = Q(t), a = void 0, r = {};
                K.removeAll(n);
    ...
    u.prototype.value = function (i, e, t) {
        ...
        if (K.isArray(e)) {
            var r = Q('[xid="' + i + '"]'), l = {}, o = void 0, s = true;
            if (t == false) {
                s = false
            } else if (t == true) {
                s = true
    ...
    u.prototype.search = function (e, t) {
        if (e && K.check(e)) {
            Y[e] = Q.extend(true, {}, Y[e] || X, {first: true, searchVal: t});
