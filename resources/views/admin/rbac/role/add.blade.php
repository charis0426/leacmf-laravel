                ...
                <form class="layui-form" style="width: 500px;">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="title" v-model="formData.title" placeholder="角色名称" value=""
                                   class="layui-input">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="name" v-model="formData.name" placeholder="角色标识" value=""
                                   class="layui-input">
                        </div>
                    </div>
                    <div class="layui-form-item layui-form-text">
                        ...
                        <div class="layui-input-block">
                            <textarea name="remark" v-model="formData.remark" class="layui-textarea"
                                      placeholder="描述"></textarea>
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <div class="layui-input-block">
                            <button class="layui-btn layui-btn-sm" type="button" @click="addRole()">立即提交</button>
