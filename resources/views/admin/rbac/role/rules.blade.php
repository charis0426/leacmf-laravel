...
<div style="width: 80px;float: left;text-align: center;">
    <p style="margin-top: 180px;">
        <button class="layui-btn layui-btn-xs" id="to-right"><i class="layui-icon layui-icon-right"></i></button>
    </p>
    <p style="margin-top: 20px;">
        <button class="layui-btn layui-btn-xs" id="to-left"><i class="layui-icon layui-icon-left"></i></button>
    </p>
</div>
