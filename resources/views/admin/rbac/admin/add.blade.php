    ...
    <form class="layui-form"  style="width: 500px;" >
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="username" v-model="formData.username" placeholder="用户名" value="" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            <div class="layui-input-block">
                <button class="layui-btn"type="button" @click="addAdmin()">立即提交</button>
