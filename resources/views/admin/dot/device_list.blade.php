...
<div id="app" class="layui-fluid">
    <div class="layui-form-item" style="margin-top: 20px">
        ...
        <div class="layui-inline">
            <div class="layui-input-inline">
                <button class="layui-btn" @click="getList(1,10,department_id,name)"><i class="layui-icon">&#xe615;</i>搜索</button>
            </div>
        </div>
    </div>
    >
                ...
                <tr v-for="(vo,id) in formData">
                    ...
                    <td>
                        <a :href="'transportation/show/'+vo['id']"
                           class="layui-btn layui-btn-xs ajax-form" title="">详情</a>
                        <a :href="'transportation/device/'+vo['id']" class="layui-btn layui-btn-xs layui-btn-normal"
                           title="">资源</a>
                    </td>
                </tr>
                </tbody>
...
//                    },1000);
    ...
    $("body").on("mousedown", ".layui-tree a", function () {
        ...
        $(this).find('cite').css('color', '#39d4c4');
    });
</script>
