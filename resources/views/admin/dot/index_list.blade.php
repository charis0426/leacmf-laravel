        ...
        <div class="layui-row layui-form">
            <div class="layui-inline layui-form-serch">
                ...
                <div class="layui-input-inline">
                    <select name="modules"  id="selectData" lay-filter="selectData" placeholder="请输入网点名称" lay-verify="" lay-search>
                        <option value="">请输入网点名称</option>
                        <option :value="id" v-for="va,id  in dotList">@{{ va }}</option>
                    </select>
                </div>
            </div>
        ...
        <div class="layui-row main">
            <div class="layui-col-md8">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="title" lay-verify="title" readonly class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    <div class="layui-input-block">
        ...
        methods: {
            ...
            DvDetail: function (type, id, name) {
                if (type == 1) {
                    ...
                    this.dv_title = name
                    this.$http.post('/admin/dot/device/' + id, {}, {emulateJSON: true})
                        .then(function (res) {
                                if (res.body.code == 0) {
            ...
            getAllDot: function () {
                this.$http.get('/admin/dot/list', {emulateJSON: true})
                    .then(function (res) {
                            if (res.body.code == 0) {
                                this.dotList = res.body.data
                                this.$nextTick(function () {
                                  this.form.render();
                                })
                            } else {
